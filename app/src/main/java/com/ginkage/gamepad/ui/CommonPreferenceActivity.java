...
public class CommonPreferenceActivity extends AppCompatActivity
  ...
  protected void onStart() {
    ...
    if (fragment instanceof PreferenceFragmentCompat) {
      CharSequence title = ((PreferenceFragmentCompat) fragment).getPreferenceScreen().getTitle();
  ...
  public void startPreferenceFragment(Fragment fragment, boolean push) {
    if (push) {
      startActivity(
          onBuildStartFragmentIntent(fragment.getClass().getName(), fragment.getArguments(), 0));
    } else {
